...
export class RoundResultChecking extends Component {
  ...
  componentDidMount() {
    checkRoundResult().then((roundResult) => { this.setState(roundResult); });
  }
  ...
  componentWillUnmount() { clearTimeout(this.roundStartedCheckingId); }
  ...
  render() {
    ...
    return (
        <div className = "GlobalGrid"><div className = "HeadBox">
        <div className = "Title">Top Ten<
            /div>
  ...
  render() {
        return (
            <div className="GlobalGrid">
                ...
                <div className="BottomBox">
                    <Users getUsersListHandler={getGamePlayers} checkOnlyOnce={true} displayNumbers={
      false}/>
